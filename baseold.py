...
from litex_boards.platforms import cain_test_i5
...
class BaseSoC(SoCCore):
    def __init__(self):
        ...
        platform = cain_test_i5.Platform()
        ...
        SoCCore.__init__(self, platform,
            ...
            integrated_rom_size      = 0xAA20,
            integrated_sram_size     = 0xbff)
        ...
        self.add_csr("leds")
        platform.add_extension(cain_test_i5._sdcard_io)
        self.add_spi_sdcard()
# Build --------------------------------------------------------------------------------------------
soc = BaseSoC()
